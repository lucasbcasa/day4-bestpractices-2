...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "fastloopTeacher",
        "sources": [
            "fastloopTeacher.pyx"
        ]
    },
    "module_name": "fastloopTeacher"
}
END: Cython Metadata */
...
#define __PYX_HAVE__fastloopTeacher
#define __PYX_HAVE_API__fastloopTeacher
/* Early includes */
#include "math.h"
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'fastloopTeacher' */
...
#define __Pyx_MODULE_NAME "fastloopTeacher"
extern int __pyx_module_is_main_fastloopTeacher;
int __pyx_module_is_main_fastloopTeacher = 0;

/* Implementation of 'fastloopTeacher' */
...
static const char __pyx_k_fastloopTeacher[] = "fastloopTeacher";
...
static const char __pyx_k_fastloopTeacher_pyx[] = "fastloopTeacher.pyx";
...
static PyObject *__pyx_n_s_fastloopTeacher;
static PyObject *__pyx_kp_s_fastloopTeacher_pyx;
...
static PyObject *__pyx_pf_15fastloopTeacher_rbf_network_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_beta, int __pyx_v_theta); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_15fastloopTeacher_1rbf_network_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_15fastloopTeacher_1rbf_network_cython = {"rbf_network_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15fastloopTeacher_1rbf_network_cython, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_15fastloopTeacher_1rbf_network_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("rbf_network_cython (wrapper)", 0);
  {
    ...
    __pyx_v_X = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_X.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_beta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_beta.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("fastloopTeacher.rbf_network_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15fastloopTeacher_rbf_network_cython(__pyx_self, __pyx_v_X, __pyx_v_beta, __pyx_v_theta);
...
static PyObject *__pyx_pf_15fastloopTeacher_rbf_network_cython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_X, __Pyx_memviewslice __pyx_v_beta, int __pyx_v_theta) {
  int __pyx_v_N;
  int __pyx_v_D;
 ...
 */
  ...
  __pyx_v_Y_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "fastloopTeacher.pyx":11
 *     cdef int D = X.shape[1]
 *     Y_np = np.zeros(N)
 *     cdef double[:] Y=Y_np             # <<<<<<<<<<<<<<
 *     cdef int j = 0
 *     cdef int i = 0
 */
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_Y_np, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_v_Y = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "fastloopTeacher.pyx":12
 *     Y_np = np.zeros(N)
 *     cdef double[:] Y=Y_np
 *     cdef int j = 0             # <<<<<<<<<<<<<<
 *     cdef int i = 0
 ...
 */
      while (1) {
        __pyx_t_6 = ((__pyx_v_d < __pyx_v_D) != 0);
        if (!__pyx_t_6) break;

        /* "fastloopTeacher.pyx":22
 *             d = 0
 *             while d < D:
 *                 r += (X[j, d] - X[i, d]) ** 2             # <<<<<<<<<<<<<<
 *                 d += 1
 ...
 */
        ...
        } else if (unlikely(__pyx_t_11 >= __pyx_v_X.shape[1])) __pyx_t_9 = 1;
        if (unlikely(__pyx_t_9 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_9);
          __PYX_ERR(0, 22, __pyx_L1_error)
        }
        __pyx_v_r = (__pyx_v_r + pow(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_7 * __pyx_v_X.strides[0]) ) + __pyx_t_8 * __pyx_v_X.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_10 * __pyx_v_X.strides[0]) ) + __pyx_t_11 * __pyx_v_X.strides[1]) )))), 2.0));

        /* "fastloopTeacher.pyx":23
 *             while d < D:
 *                 r += (X[j, d] - X[i, d]) ** 2
 *                 d += 1             # <<<<<<<<<<<<<<
 *             r = r**0.5
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_beta.shape[0];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_beta.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_Y.data + __pyx_t_10 * __pyx_v_Y.strides[0]) )) += ((*((double *) ( /* dim=0 */ (__pyx_v_beta.data + __pyx_t_11 * __pyx_v_beta.strides[0]) ))) * exp((-powf((__pyx_v_r * __pyx_v_theta), 2.0))));

      /* "fastloopTeacher.pyx":26
 *             r = r**0.5
 *             Y[i] += beta[j] * exp(-(r * theta)**2)
 *             j += 1             # <<<<<<<<<<<<<<
 *         i += 1
 ...
 */
  ...
  /* "fastloopTeacher.pyx":29
 *         i += 1
 * 
 *     return Y             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_Y, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastloopTeacher.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastloopTeacher._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_fastloopTeacher(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fastloopTeacher},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fastloopTeacher, __pyx_k_fastloopTeacher, sizeof(__pyx_k_fastloopTeacher), 0, 0, 1, 1},
  {&__pyx_kp_s_fastloopTeacher_pyx, __pyx_k_fastloopTeacher_pyx, sizeof(__pyx_k_fastloopTeacher_pyx), 0, 0, 1, 0},
 ...
 *     cdef int N = X.shape[0]
 */
  __pyx_tuple__19 = PyTuple_Pack(11, __pyx_n_s_X, __pyx_n_s_beta, __pyx_n_s_theta, __pyx_n_s_N, __pyx_n_s_D, __pyx_n_s_Y_np, __pyx_n_s_Y, __pyx_n_s_j, __pyx_n_s_i, __pyx_n_s_d, __pyx_n_s_r); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(3, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_fastloopTeacher_pyx, __pyx_n_s_rbf_network_cython, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 6, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfastloopTeacher(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfastloopTeacher(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fastloopTeacher(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fastloopTeacher(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fastloopTeacher(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fastloopTeacher' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fastloopTeacher(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fastloopTeacher", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fastloopTeacher) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fastloopTeacher")) {
      if (unlikely(PyDict_SetItemString(modules, "fastloopTeacher", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int N = X.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_15fastloopTeacher_1rbf_network_cython, NULL, __pyx_n_s_fastloopTeacher); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fastloopTeacher", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fastloopTeacher");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
